...
const lesson = 'Two-Variable Linear Inequalities';
const slug = 'two-variable-linear-inequalities';
const route = 'algebra/linear-inequalities/two-variable-linear-inequalities/video/english/index.html';
const url = 'https://scrimba.com/explain/guide01grohg2k?claim=68tui96f9p4d62ur&fullscreen=1';
