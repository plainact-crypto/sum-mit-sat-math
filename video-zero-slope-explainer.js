...
const lesson = 'Zero Slope';
const slug = 'zero-slope';
const url = 'https://scrimba.com/explain/guide0ksmphbu0?claim=1ee90o1haatt371u&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/zero-slope/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
