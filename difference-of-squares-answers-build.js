...
const source=path.join(__dirname,'difference-of-squares-answers.html');
const route='advanced-math/factoring/difference-of-squares/answers';
if(!fs.existsSync(source)) throw new Error('Missing Difference of Squares answers source');
...
if(fs.existsSync(schedulePath)){
  const target='/advanced-math/factoring/difference-of-squares/answers/';
