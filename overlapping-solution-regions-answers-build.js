...
const route='/algebra/systems-of-linear-inequalities/overlapping-solution-regions/answers/';
const target=path.join(dist,route.replace(/^\//,''));
fs.mkdirSync(target,{recursive:true});
fs.copyFileSync(path.join(root,'overlapping-solution-regions-answers.html'),path.join(target,'index.html'));
...
console.log('Built Overlapping Solution Regions answers.');