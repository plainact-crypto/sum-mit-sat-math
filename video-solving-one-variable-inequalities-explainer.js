...
const lesson = 'Solving One-Variable Inequalities';
const slug = 'solving-one-variable-inequalities';
const url = 'https://scrimba.com/explain/guide003ri2i8o?claim=1tt2j3brmp5tmnfk&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-inequalities/solving-one-variable-inequalities/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
