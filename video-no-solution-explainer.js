...
const lesson = 'No Solution';
const slug = 'no-solution';
const url = 'https://scrimba.com/explain/guide0r8grhkmc?claim=2h603dijgpjkvehd&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/systems-of-linear-equations/no-solution/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
