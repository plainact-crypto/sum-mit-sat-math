...
const lesson = 'Shading Solution Regions';
const slug = 'shading-solution-regions';
const routeSlug = 'shading-solution-regions';
const url = 'https://scrimba.com/explain/guide0v3kqvn7q?claim=lp89oqf8qnjl0mio&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith(`algebra/linear-inequalities/${routeSlug}/video/english/index.html`) && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
