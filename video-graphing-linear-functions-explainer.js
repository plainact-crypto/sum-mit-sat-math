...
const slug = 'graphing-linear-functions';
const routeSlug = 'graphing-linear-functions';
const url = 'https://scrimba.com/explain/guide03tpoqr56?claim=a937a1vriaatns3m&fullscreen=1';
