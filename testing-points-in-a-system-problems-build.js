...
const root=__dirname,dist=path.join(root,'dist'),source=path.join(root,'testing-points-in-a-system-problems.html');
if(!fs.existsSync(source))throw new Error('Missing testing-points-in-a-system-problems.html');
