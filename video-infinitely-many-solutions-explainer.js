...
const lesson = 'Infinitely Many Solutions';
const slug = 'infinitely-many-solutions';
const url = 'https://scrimba.com/explain/guide0sui6pbni?claim=ojl2gn30eu8pnuim&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/systems-of-linear-equations/infinitely-many-solutions/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
