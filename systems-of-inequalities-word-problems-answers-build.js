...
const route='/algebra/systems-of-linear-inequalities/systems-of-inequalities-word-problems/answers/';
const target=path.join(dist,route.replace(/^\//,''));
fs.mkdirSync(target,{recursive:true});
fs.copyFileSync(path.join(root,'systems-of-inequalities-word-problems-answers.html'),path.join(target,'index.html'));
...
console.log('Built Systems of Inequalities Word Problems answers.');