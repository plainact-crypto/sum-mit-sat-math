...
const lesson = 'Finding X-Intercept';
const slug = 'finding-x-intercept';
const url = 'https://scrimba.com/explain/guide0bln7agot?claim=6f1qccpbnkgtfu36&fullscreen=1';
