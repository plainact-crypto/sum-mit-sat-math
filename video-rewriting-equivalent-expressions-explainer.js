...
const lesson = 'Rewriting Equivalent Expressions';
const slug = 'rewriting-equivalent-expressions';
const route = 'advanced-math/equivalent-expressions/rewriting-equivalent-expressions/video/english/index.html';
const url = 'https://scrimba.com/explain/guide01h8u3fsn?claim=qd1s8e5lgf5msvgs&fullscreen=1';
