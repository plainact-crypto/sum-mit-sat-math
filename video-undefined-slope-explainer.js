...
const lesson = 'Undefined Slope';
const slug = 'undefined-slope';
const url = 'https://scrimba.com/explain/guide0uholt1tj?claim=vu1bad2i7uf1jclc&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/undefined-slope/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
