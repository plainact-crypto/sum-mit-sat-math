...
if(html.includes('SUMMIT_EXPLAINER:discriminant')){console.log('Discriminant explainer already embedded.');require('./video-one-real-solution-explainer');process.exit(0)}
...
require('./video-one-real-solution-explainer');
