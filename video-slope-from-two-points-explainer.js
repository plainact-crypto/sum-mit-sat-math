...
const lesson = 'Slope from Two Points';
const slug = 'slope-from-two-points';
const url = 'https://scrimba.com/explain/guide0fnkikiom?claim=8vjl1bon3t8jp96o&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/slope-from-two-points/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
