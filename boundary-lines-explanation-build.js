...
const source=path.join(root,'boundary-lines-explanation.html');
if(!fs.existsSync(source))throw new Error('Missing boundary-lines-explanation.html');
const route='/algebra/linear-inequalities/boundary-lines/explanation/';
