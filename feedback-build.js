...
const inject='<script src="/sum-mit-sat-math/feedback-email-hook.js"></script><script src="/sum-mit-sat-math/feedback-widget.js"></script>';
...
walk(dist);
console.log('Feedback widget + email hook injected into lesson pages.');