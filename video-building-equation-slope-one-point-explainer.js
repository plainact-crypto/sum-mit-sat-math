...
const lesson = 'Building an Equation from Slope and One Point';
const slug = 'building-equation-slope-one-point';
const routeSlug = 'building-an-equation-from-slope-and-one-point';
const url = 'https://scrimba.com/explain/guide094vl8iak?claim=6ihcd26278fbb81q&fullscreen=1';
