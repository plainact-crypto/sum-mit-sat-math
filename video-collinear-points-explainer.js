...
const lesson = 'Collinear Points';
const slug = 'collinear-points';
const routeSlug = 'collinear-points';
const url = 'https://scrimba.com/explain/guide0evccfegi?claim=6uincoi3thffpvmk&fullscreen=1';
