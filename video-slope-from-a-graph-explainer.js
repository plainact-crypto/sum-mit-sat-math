...
const lesson = 'Slope from a Graph';
const slug = 'slope-from-a-graph';
const url = 'https://scrimba.com/explain/guide0n1rb122g?claim=va3e5j34pg1j3rfi&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/slope-from-a-graph/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
