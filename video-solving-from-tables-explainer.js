...
const lesson = 'Solving from Tables';
const slug = 'solving-from-tables';
const route = 'algebra/systems-of-linear-equations/solving-from-tables/video/english/index.html';
const url = 'https://scrimba.com/explain/guide0nt9d3ip8?claim=eeorf199nbd1p7s4&fullscreen=1';
