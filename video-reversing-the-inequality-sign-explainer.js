...
const lesson = 'Reversing the Inequality Sign';
const slug = 'reversing-the-inequality-sign';
const url = 'https://scrimba.com/explain/guide02l3i8tok?claim=6r69smbfmtu2mjdi&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-inequalities/reversing-the-inequality-sign/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
