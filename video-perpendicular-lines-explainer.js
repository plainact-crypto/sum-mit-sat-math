...
const lesson = 'Perpendicular Lines';
const slug = 'perpendicular-lines';
const url = 'https://scrimba.com/explain/guide00unjeacs?claim=16hncgtq821v0t4u&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/perpendicular-lines/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
