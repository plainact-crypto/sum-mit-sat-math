...
const source=path.join(root,'two-real-solutions-test.html');
const dist=path.join(root,'dist');
const route='/advanced-math/quadratic-equations/two-real-solutions/test/';
const target=path.join(dist,'advanced-math','quadratic-equations','two-real-solutions','test');
if(!fs.existsSync(source)) throw new Error('Missing Two Real Solutions test source');
...
console.log('Built Two Real Solutions lesson test route');
