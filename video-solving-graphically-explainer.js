...
const lesson = 'Solving Graphically';
const slug = 'solving-graphically';
const url = 'https://scrimba.com/explain/guide0q20uh6l1?claim=7g1o3t9se1se8rns&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/systems-of-linear-equations/solving-graphically/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
