...
const source=path.join(root,'shading-solution-regions-test.html');
if(!fs.existsSync(source))throw new Error('Missing shading-solution-regions-test.html');
const route='/algebra/linear-inequalities/shading-solution-regions/test/';
