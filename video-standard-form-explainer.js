...
const url = 'https://scrimba.com/explain/guide0gani2j9i?claim=jd2komorf9tu2i7l&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-equations-in-two-variables/standard-form/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
