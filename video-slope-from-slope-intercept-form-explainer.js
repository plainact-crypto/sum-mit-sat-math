...
const lesson = 'Slope from Slope-Intercept Form';
const slug = 'slope-from-slope-intercept-form';
const url = 'https://scrimba.com/explain/guide0d3s01qu2?claim=60hboponqmks00o2&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/slope-from-slope-intercept-form/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
