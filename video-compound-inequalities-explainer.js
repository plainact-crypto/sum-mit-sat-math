...
const lesson = 'Compound Inequalities';
const slug = 'compound-inequalities';
const url = 'https://scrimba.com/explain/guide0bmcman74?claim=i6mjei1sb80vqb12&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-inequalities/compound-inequalities/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
