...
const lesson = 'One Solution';
const slug = 'one-solution';
const url = 'https://scrimba.com/explain/guide07i9uo5pa?claim=82ee5rnb8mksrtbi&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/systems-of-linear-equations/one-solution/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
