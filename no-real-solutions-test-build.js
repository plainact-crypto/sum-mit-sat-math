...
const source=path.join(root,'no-real-solutions-test.html');
const dist=path.join(root,'dist');
const route='/advanced-math/quadratic-equations/no-real-solutions/test/';
const target=path.join(dist,'advanced-math','quadratic-equations','no-real-solutions','test');
if(!fs.existsSync(source)) throw new Error('Missing No Real Solutions test source');
...
console.log('Built No Real Solutions lesson test route');