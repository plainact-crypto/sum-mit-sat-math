...
const source=path.join(root,'sum-of-roots-test.html');
const dist=path.join(root,'dist');
const route='/advanced-math/quadratic-equations/sum-of-roots/test/';
const target=path.join(dist,'advanced-math','quadratic-equations','sum-of-roots','test');
if(!fs.existsSync(source)) throw new Error('Missing Sum of Roots test source');
...
console.log('Built Sum of Roots lesson test route');
