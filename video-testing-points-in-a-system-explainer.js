...
const lesson = 'Testing Points in a System';
const slug = 'testing-points-in-a-system';
const routeSlug = 'testing-points-in-a-system';
const url = 'https://scrimba.com/explain/guide0p6uib10t?claim=f4di703vs8bc8sq9&fullscreen=1';
...
if (!html.includes(tag)) {
  ...
  const body = `<div class="summit-video-shell summit-explainer-player" data-requested-voice-gender="female" data-voice-gender-status="unavailable"><!-- ${tag} --><div class="summit-explainer-frame"><iframe src="${url}" title="${lesson} — SUMMIT MATH video lesson" loading="eager" allow="autoplay; fullscreen" allowfullscreen referrerpolicy="strict-origin-when-cross-origin"></iframe></div><div class="summit-explainer-actions"><a href="${url}" target="_blank" rel="noopener">Open full-screen lesson ↗</a></div><p class="video-note">English · Teacher-style explanation · Worked examples · Strict/inclusive boundaries · Common mistakes · Quick check</p></div>${style}`;
