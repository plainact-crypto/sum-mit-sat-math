...
const route='/algebra/systems-of-linear-inequalities/graphing-systems-of-inequalities/answers/';
const target=path.join(dist,route.replace(/^\//,''));
fs.mkdirSync(target,{recursive:true});
fs.copyFileSync(path.join(root,'graphing-systems-of-inequalities-answers.html'),path.join(target,'index.html'));
...
console.log('Built Graphing Systems of Inequalities answers.');
