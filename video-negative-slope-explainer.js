...
const lesson = 'Negative Slope';
const slug = 'negative-slope';
const url = 'https://scrimba.com/explain/guide0n5sug9kj?claim=80j05chbnelkafd6&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/negative-slope/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
