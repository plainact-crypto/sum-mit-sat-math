...
const root=__dirname,dist=path.join(root,'dist'),source=path.join(root,'factoring-by-grouping-problems.html');
...
console.log('Built Factoring by Grouping problems route and completed its schedule entry');
