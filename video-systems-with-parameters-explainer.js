...
const lesson = 'Systems with Parameters';
const slug = 'systems-with-parameters';
const url = 'https://scrimba.com/explain/guide0tfp07h7j?claim=366qoumrfj5a0gbu&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/systems-of-linear-equations/systems-with-parameters/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
