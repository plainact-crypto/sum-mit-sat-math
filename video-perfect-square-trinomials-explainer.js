...
const lesson = 'Perfect-Square Trinomials';
const slug = 'perfect-square-trinomials';
const route = 'advanced-math/factoring/perfect-square-trinomials/video/english/index.html';
const url = 'https://scrimba.com/explain/guide0j8htevhs?claim=b8q3pjmb1ufos54q&fullscreen=1';
...
if (hits.length === 0) {
  ...
  const shell = `<!doctype html><html lang="en" data-theme="light"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" href="/styles.css"><title>${lesson} — Video Explanation | SUMMIT MATH</title></head><body><main class="page-shell"><section class="lesson-card"><div class="crumb">Advanced Math · Factoring</div><div class="page-type">${marker}</div><div class="lesson-title">${lesson}</div><div class="subject-label">Advanced Math</div>${oldBody}<a class="back" href="../../explanation/">← Back to explanation</a></section></main></body></html>`;
