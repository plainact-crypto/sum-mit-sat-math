...
const lesson = 'Greatest Common Factor';
const slug = 'greatest-common-factor';
const route = 'advanced-math/factoring/greatest-common-factor/video/english/index.html';
const url = 'https://scrimba.com/explain/guide0f17dm5s7?claim=kgairqhujdede6ig&fullscreen=1';
