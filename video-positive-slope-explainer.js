...
const lesson = 'Positive Slope';
const slug = 'positive-slope';
const url = 'https://scrimba.com/explain/guide025m0n9hk?claim=riohugm2v27f2go5&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/positive-slope/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
