...
const lesson = 'Building an Equation from Two Points';
const slug = 'building-equation-two-points';
const routeSlug = 'building-an-equation-from-two-points';
const url = 'https://scrimba.com/explain/guide0bmepmjp4?claim=tgdtrc6d38s7qpd9&fullscreen=1';
