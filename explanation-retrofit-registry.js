...
module.exports=[
  ...
  {slug:'difference-of-squares',lesson:'Difference of Squares',classification:'DESMOS',graph:null,desmos:{enter:'y=x^2-25',lookFor:'the x-intercepts at x = -5 and x = 5',useIt:'use the zeros to verify the factorization (x-5)(x+5)',why:'a zero r corresponds to a factor (x-r), so roots 5 and -5 correspond to factors (x-5) and (x+5)',faster:'Usually not for obvious perfect squares. The algebraic pattern is faster; Desmos is useful as a verification tool.',crossCheck:'At x=5, 25-25=0. At x=-5, 25-25=0. Expanding (x-5)(x+5) gives x^2-25.'}}
];
