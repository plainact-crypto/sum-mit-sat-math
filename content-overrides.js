...
const overrides=[
  ...
  {base:path.join(dist,'algebra','linear-functions','slope-from-two-points'),files:[['explanation','slope-from-two-points-explanation.html'],['problems','slope-from-two-points-problems.html']]},
...
const completedRoutes=new Set([
  ...
  '/algebra/linear-functions/slope-from-two-points/problems/',
