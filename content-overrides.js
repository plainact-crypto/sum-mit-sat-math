...
const overrides=[
  ...
  {base:path.join(dist,'algebra','linear-equations-in-two-variables','converting-between-forms'),files:[['explanation','converting-between-forms-explanation.html'],['problems','converting-between-forms-problems.html']]}
];
