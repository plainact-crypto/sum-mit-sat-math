...
const lesson = 'Systems Word Problems';
const slug = 'systems-word-problems';
const url = 'https://scrimba.com/explain/guide09sa33938?claim=j22dpreqdsjpbj2p&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/systems-of-linear-equations/systems-word-problems/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
