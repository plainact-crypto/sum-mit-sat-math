...
const lesson = 'Slope from Standard Form';
const slug = 'slope-from-standard-form';
const url = 'https://scrimba.com/explain/guide009skq4uk?claim=o7857nqv57ihai0a&fullscreen=1';
...
const hits = walk(dist).filter(file => {
  ...
  return normalized.endsWith('algebra/linear-functions/slope-from-standard-form/video/english/index.html') && html.includes(`<div class="lesson-title">${lesson}</div>`) && html.includes(marker);
});
