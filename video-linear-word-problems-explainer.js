...
const lesson = 'Linear Equation Word Problems';
const slug = 'linear-word-problems';
const url = 'https://scrimba.com/explain/guide0blmua87u?claim=i7sn0or9b2hhbmqn&fullscreen=1';
