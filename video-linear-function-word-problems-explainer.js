...
const lessons = [
  {
    lesson: 'Linear Function Word Problems',
    slug: 'linear-function-word-problems',
    url: 'https://scrimba.com/explain/guide0roi59nuh?claim=8i65rn6rs3ghr59b&fullscreen=1',
    note: 'English · Teacher-style explanation · Verified linear model graph · Worked examples · Desmos strategy · Quick check'
  },
  {
    lesson: 'Linear Equation Word Problems',
    slug: 'linear-word-problems',
    url: 'https://scrimba.com/explain/guide0ov8gqke2?claim=239uev1pjjk4dku2&fullscreen=1',
    note: 'English · Teacher-style explanation · Translation patterns · Worked examples · Exam strategy · Quick check'
  }
];
